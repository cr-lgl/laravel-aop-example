...
use App\Models\User;
use App\Services\GoAopCreateUserService;
...
/**
 * Class GoAopCreateUserServiceTest
 * @package Tests\Integration\Services
 */
class GoAopCreateUserServiceTest extends TestCase
{
    use RefreshDatabase;
    use WithFaker;
    ...
    public function can_create_a_user(): void
    {
        ...
        $service = resolve(GoAopCreateUserService::class);
